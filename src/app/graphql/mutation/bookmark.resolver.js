...
class BookmarkMutation {
    ...
    bookmarkProduct = {
        ...
        resolve : async (obj , args , context , info) => {
            ...
            const product = await productModel.updateOne({_id : productId} , {$addToSet : {bookmarks : userId}})
    ...
    bookmarkCourse = {
        ...
        resolve : async (obj , args , context , info) => {
            ...
            const course = await courseModel.updateOne({_id : courseId} , {$addToSet : {bookmarks : userId}})
    ...
    bookmarkBlog = {
        ...
        resolve : async (obj , args , context , info) => {
            ...
            const blog = await blogModel.updateOne({_id : blogId} , {$addToSet : {bookmarks : userId}})
